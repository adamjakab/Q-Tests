...
$qit_queueclient_js = file_get_contents(dirname(__DIR__) . '/_connector/queueclient.min.js');
$qit_queueconfigloader_js = file_get_contents(dirname(__DIR__) . '/_connector/queueconfigloader.min.js');
